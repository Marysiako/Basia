...
int main()
{
    ...
    FRET tablicaObiektow[] = {
        FRET(57, 200, 50, 45, 101, "G"),
        FRET(107, 200, 55, 45, 101, "Gis"),
        FRET(162, 200, 55, 45, 101, "Gis"),
        FRET(217, 200, 50, 45, 101, "Gis"),
        FRET(267, 200, 48, 45, 101, "Gis"),
        FRET(315, 200, 45, 45, 101, "Gis"),
        FRET(360, 200, 40, 45, 101, "Gis"),
        FRET(400, 200, 40, 45, 101, "Gis"),
        FRET(440, 200, 38, 45, 101, "Gis"),
        FRET(478, 200, 35, 45, 101, "Gis"), //10
        FRET(513, 200, 30, 45, 101, "Gis"),
        FRET(543, 200, 32, 45, 101, "Gis"),
        FRET(575, 200, 32, 45, 101, "Gis"),
        FRET(607, 200, 32, 45, 101, "Gis"),
        FRET(639, 200, 35, 45, 101, "Gis"), //15
        FRET(674, 200, 33, 45, 101, "Gis"),
        FRET(707, 200, 33, 45, 101, "Gis"),
        FRET(740, 200, 30, 45, 101, "Gis"),
        FRET(770, 200, 30, 45, 101, "Gis"),
        FRET(800, 200, 35, 45, 101, "Gis"), //20
        FRET(835, 200, 34, 45, 101, "Gis"),
        FRET(869, 200, 30, 45, 101, "Gis"),
        FRET(899, 200, 32, 45, 101, "Gis"),
        FRET(931, 200, 35, 45, 101, "Gis"), //24

        FRET(57, 245, 50, 40, 101, "G"),
        FRET(107, 245, 55, 40, 101, "Gis"),
        FRET(162, 245, 55, 40, 101, "Gis"),
        FRET(217, 245, 50, 40, 101, "Gis"),
        FRET(267, 245, 48, 40, 101, "Gis"),
        FRET(315, 245, 45, 40, 101, "Gis"),
        FRET(360, 245, 40, 40, 101, "Gis"),
        FRET(400, 245, 40, 40, 101, "Gis"),
        FRET(440, 245, 38, 40, 101, "Gis"),
        FRET(478, 245, 35, 40, 101, "Gis"), //10
        FRET(513, 245, 30, 40, 101, "Gis"),
        FRET(543, 245, 32, 40, 101, "Gis"),
        FRET(575, 245, 32, 40, 101, "Gis"),
        FRET(607, 245, 32, 40, 101, "Gis"),
        FRET(639, 245, 35, 40, 101, "Gis"), //15
        FRET(674, 245, 33, 40, 101, "Gis"),
        FRET(707, 245, 33, 40, 101, "Gis"),
        FRET(740, 245, 30, 40, 101, "Gis"),
        FRET(770, 245, 30, 40, 101, "Gis"),
        FRET(800, 245, 35, 40, 101, "Gis"), //20
        FRET(835, 245, 34, 40, 101, "Gis"),
        FRET(869, 245, 30, 40, 101, "Gis"),
        FRET(899, 245, 32, 40, 101, "Gis"),
        FRET(931, 245, 35, 40, 101, "Gis"), //24

        FRET(57, 285, 50, 40, 101, "G"),
        FRET(107, 285, 55, 40, 101, "Gis"),
        FRET(162, 285, 55, 40, 101, "Gis"),
        FRET(217, 285, 50, 40, 101, "Gis"),
        FRET(267, 285, 48, 40, 101, "Gis"),
        FRET(315, 285, 45, 40, 101, "Gis"),
        FRET(360, 285, 40, 40, 101, "Gis"),
        FRET(400, 285, 40, 40, 101, "Gis"),
        FRET(440, 285, 38, 40, 101, "Gis"),
        FRET(478, 285, 35, 40, 101, "Gis"), //10
        FRET(513, 285, 30, 40, 101, "Gis"),
        FRET(543, 285, 32, 40, 101, "Gis"),
        FRET(575, 285, 32, 40, 101, "Gis"),
        FRET(607, 285, 32, 40, 101, "Gis"),
        FRET(639, 285, 35, 40, 101, "Gis"), //15
        FRET(674, 285, 33, 40, 101, "Gis"),
        FRET(707, 285, 33, 40, 101, "Gis"),
        FRET(740, 285, 30, 40, 101, "Gis"),
        FRET(770, 285, 30, 40, 101, "Gis"),
        FRET(800, 285, 35, 40, 101, "Gis"), //20
        FRET(835, 285, 34, 40, 101, "Gis"),
        FRET(869, 285, 30, 40, 101, "Gis"),
        FRET(899, 285, 32, 40, 101, "Gis"),
        FRET(931, 285, 35, 40, 101, "Gis"), //24

        FRET(57, 325, 50, 35, 101, "G"),
        FRET(107, 325, 55, 35, 101, "Gis"),
        FRET(162, 325, 55, 35, 101, "Gis"),
        FRET(217, 325, 50, 35, 101, "Gis"),
        FRET(267, 325, 48, 35, 101, "Gis"),
        FRET(315, 325, 45, 35, 101, "Gis"),
        FRET(360, 325, 40, 35, 101, "Gis"),
        FRET(400, 325, 40, 35, 101, "Gis"),
        FRET(440, 325, 38, 35, 101, "Gis"),
        FRET(478, 325, 35, 35, 101, "Gis"), //10
        FRET(513, 325, 30, 35, 101, "Gis"),
        FRET(543, 325, 32, 35, 101, "Gis"),
        FRET(575, 325, 32, 35, 101, "Gis"),
        FRET(607, 325, 32, 35, 101, "Gis"),
        FRET(639, 325, 35, 35, 101, "Gis"), //15
        FRET(674, 325, 33, 35, 101, "Gis"),
        FRET(707, 325, 33, 35, 101, "Gis"),
        FRET(740, 325, 30, 35, 101, "Gis"),
        FRET(770, 325, 30, 35, 101, "Gis"),
        FRET(800, 325, 35, 35, 101, "Gis"), //20
        FRET(835, 325, 34, 35, 101, "Gis"),
        FRET(869, 325, 30, 35, 101, "Gis"),
        FRET(899, 325, 32, 35, 101, "Gis"),
        FRET(931, 325, 35, 35, 101, "Gis"), //24
